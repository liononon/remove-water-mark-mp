App({
                            ...
                            wx.getUserInfo({
                                success: res => {
                                    ...
                                    if (!this.checkIsLogin()) {
                                        this.getToken(code, res.rawData, res.signature, res.encryptedData, res.iv);
                                    }
    ...
    globalData: {
        ...
        hasUserInfo: false,
        //生产域名
        apiDomain: 'http://127.0.0.1:7899/media/quick/v1', 
     ...
     * 获取token
     */
    getToken(code, rawData, signature, encryptedData, iv, callback = null) {
        //调后端接口获取token
        this.apiRequest({
            url: '/auth/login',
            method: 'POST',
